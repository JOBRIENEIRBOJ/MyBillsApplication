...
<head>
    ...
    <meta name="description" content="Simple bill tracking app for managing recurring payments">
...
<body class="bg-gray-50 safe-area">
    ...
    <script type="text/babel">
        ...
        const MyBills = () => {
            ...
            const [newBill, setNewBill] = useState({ label: '', amount: '', dueDate: '' });
            ...
            useEffect(() => {
                ...
                const manifest = {
                    ...
                    theme_color: '#2563EB',
                    icons: [{
                        src: 'data:image/svg+xml;base64,' + btoa('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><rect width="512" height="512" fill="#2563EB" rx="64"/><path d="M128 160h256v32H128zm0 64h256v32H128zm0 64h192v32H128z" fill="white"/><circle cx="384" cy="288" r="16" fill="white"/><text x="256" y="400" text-anchor="middle" fill="white" font-size="48" font-family="Arial">$</text></svg>'),
                        sizes: '512x512',
                        type: 'image/svg+xml'
                    }]
                };
